...
package com.example.ljd.myscreencaptureservice.rtspserver.hw;
...
import com.example.ljd.myscreencaptureservice.rtspserver.hw.CodecManager.Codec;
...
public class EncoderDebugger {
	...
	private void debug() {
		...
		if (!checkTestNeeded()) {
			...
			if (!success) {
				Log.e(TAG,"Phone not supported with this resolution("+mWidth+"x"+mHeight+")");
