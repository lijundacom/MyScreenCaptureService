...
public class VideoQuality {
	...
	public VideoQuality(int resX, int resY, int framerate, int bitrate,int resScreenDensity) {
		...
		this.resX = resX;
		this.resY = resY;
		this.resScreenDensity = resScreenDensity;
	}
	...
	public boolean equals(VideoQuality quality) {
		...
		return (quality.resX == this.resX 			&
				...
				quality.resScreenDensity == this.resScreenDensity);
	}

	public VideoQuality clone() {
		return new VideoQuality(resX,resY,framerate,bitrate,resScreenDensity);
	}
