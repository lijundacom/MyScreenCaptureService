...
import com.example.ljd.myscreencaptureservice.rtspserver.exceptions.StorageUnavailableException;
import com.example.ljd.myscreencaptureservice.rtspserver.gl.SurfaceView;
import com.example.ljd.myscreencaptureservice.rtspserver.rtsp.RtspClient;
...
public class Session {
	...
	public Session() {
		...
		HandlerThread thread = new HandlerThread("com.example.ljd.myscreencaptureservice.rtspserver.Session");
		thread.start();
