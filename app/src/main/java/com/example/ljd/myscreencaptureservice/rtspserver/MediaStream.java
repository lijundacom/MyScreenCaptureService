...
import com.example.ljd.myscreencaptureservice.rtspserver.rtp.AbstractPacketizer;
...
public abstract class MediaStream implements Stream {
	 ...
	 * {@link VideoStream#setVideoQuality(com.example.ljd.myscreencaptureservice.rtspserver.video.VideoQuality)}
	 * for a {@link VideoStream} and {@link AudioStream#setAudioQuality(com.example.ljd.myscreencaptureservice.rtspserver.audio.AudioQuality)}
